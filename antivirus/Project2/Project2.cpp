...
{
    g_hInst = hInstance;
    RegisterWindowClass(szWindowClass, MAKEINTRESOURCE(IDI_PROJECT2), WndProc);
...
void RegisterWindowClass(PCWSTR pszClassName, PCWSTR pszMenuName, WNDPROC lpfnWndProc)
{
    ...
    wcex.hIcon = LoadIcon(g_hInst, MAKEINTRESOURCE(IDI_PROJECT2));
...
BOOL AddNotificationIcon(HWND hwnd)
{
    ...
    LoadIconMetric(g_hInst, MAKEINTRESOURCE(IDI_PROJECT2), LIM_SMALL, &nid.hIcon);
